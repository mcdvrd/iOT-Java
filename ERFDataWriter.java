...
//-----------------------------------------------------------
//. Multi-threaded data writing class.
// Class to Write EmbedRF data files. This version is NOT
// a Singleton. It is intended to be created as a paired
// Reader/Writer pair to models a Socket/Writer.
//
// This class opens a File for writing and begins to accept
// data-packets for output into a single-worker queue.
//-----------------------------------------------------------
public class ERFDataWriter extends ERFCommandBase
implements Runnable, PropertyChangeListener  
{
	...
	// pass the individual configFile and outputfile
	// name to use
	public ERFDataWriter(String theConfigFile, String dataFile)
	{
		
		this.configFileName = theConfigFile;
		this.FILE_NAME = dataFile;

		ReadConfigurationInformation();
	}
	
	//--------------------------------------------
	// Read the EmbedRF XML Configuration file
	//--------------------------------------------
